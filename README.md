...
**Navigate to the directory created in step 2.**  
`cd /mnt/kiwix`

**Then Create a library file and add all of the files you want to host to the file.  You can add as many as you want.**
